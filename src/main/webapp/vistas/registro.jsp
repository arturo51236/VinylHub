    ...
    <main class="d-flex justify-content-center align-items-center w-100" style="height: 100vh;">
        <div class="container d-flex flex-column align-items-center">
            <div class="m-auto d-flex flex-column rounded-3 border border-3 border-white" style="background-color: #2b3035; width: 30%;">
                ...
                <form:form method="post" action="register" modelAttribute="usuario">
                    <div class="row my-3 m-auto">
                        <label for="inputNombre" class="col-form-label m-auto text-center text-white">Nombre:</label><br>
                        <div class="col-sm-10 w-100">
                            <form:input type="text" name="nombre" class="form-control" id="inputNombre" placeholder="Introduce tu nombre" path="nombre"></form:input>
                        </div>
                    </div>
                    <div class="row my-3 m-auto">
