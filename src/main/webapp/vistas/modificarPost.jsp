        ...
        <div class="container" style="min-height: 80vh">
            <div class="row m-3">
                <div class="col-8 d-flex flex-row mt-4 m-auto">
                    <form:form method="post" action="modificarPost" class="w-100 text-center">
                        <label for="cantidadVisitas" class="col-form-label m-auto ms-3">Cantidad de visitas:</label><br>
                        <input type="hidden" name="idPost" value="${post.id}">
                        <input type="text" name="cantdidadVisitas" class="form-control m-3" id="cantidadVisitas" value="${post.cantidadVisitas}">
                        <label for="sello" class="col-form-label m-auto ms-3">Sello:</label><br>
                        <input type="text" name="sello" class="form-control m-3" id="sello" value="${post.sello}">
