        ...
        <div class="container" style="min-height: 80vh">
            <div class="row m-3">
                <div class="col-8 d-flex flex-row mt-4 m-auto">
                    <form:form method="post" action="modificarFormato" class="w-100 text-center">
                        <label for="nombre" class="col-form-label m-auto ms-3">Nombre:</label><br>
                        <input type="hidden" name="idFormato" value="${formato.id}">
                        <input type="text" name="nombre" class="form-control m-3" id="nombre" value="${formato.nombre}">
