...
<body>
    ...
    <main>
        <div class="container" style="min-height: 80vh">
            <div class="row m-3">
                <div class="col-8 d-flex flex-row mt-4 m-auto">
                    <form:form method="post" action="modificarUsuario" class="w-100 text-center">
                        <label for="nombre" class="col-form-label m-auto ms-3">Nombre:</label><br>
                        <input type="hidden" name="idUsuario" value="${usuario.id}">
                        <input type="text" name="nombre" class="form-control m-3" id="nombre" value="${usuario.nombre}">
                        <label for="email" class="col-form-label m-auto ms-3">Email:</label><br>
                        <input type="text" name="email" class="form-control m-3" id="email" value="${usuario.email}">
                        <label for="contrasenia" class="col-form-label m-auto ms-3">Contraseña:</label><br>
                        <input type="password" name="contrasenia" class="form-control m-3" id="contrasenia" required>
                        <label for="rol" class="col-form-label m-auto ms-3">Rol:</label><br>
                        <input type="text" name="rol" class="form-control m-3" id="rol" value="${usuario.rol}">
                        <button type="submit" class="btn btn-success p-3 rounded-4 w-100 m-3">Modificar</button>
                    </form:form>
                </div>
            </div>
        </div>
