        ...
        <div class="container" style="min-height: 80vh">
            <div class="row m-3">
                <div class="col-8 d-flex flex-row mt-4 m-auto">
                    <form:form method="post" action="insertarFormato" class="w-100 text-center">
                        <label for="nombre" class="col-form-label m-auto ms-3">Nombre:</label><br>
                        <input type="text" name="nombre" class="form-control m-3" id="nombre">
                        <button type="submit" class="btn btn-success p-3 rounded-4 w-100 m-3">Añadir</button>
                    </form:form>
                </div>
            </div>
        </div>
